...
class RolController extends Controller
{
    ...
    {
        $datas = Rol::orderBy('id')->simplePaginate(10);
        return view('admin.CONFIGURACION.rol.index', compact('datas'));
    }
    public function crear()
    {
        return view('admin.CONFIGURACION.rol.crear');
    }
    ...
    public function editar($id)
    {
        ...
        return view('admin.CONFIGURACION.rol.editar', compact('data'));
    }
