...
<div class="col-lg-12">
        ...
        <div class="card card-navy">
            <div class="card-header">
                <h3 class="card-title"><b>Administracion</b> \ Listado De Roles</h3>
                    <div class="card-tools">
                    <a href="{{route("crear_rol")}}" class="btn btn-outline-primary">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <a href="{{route("editar_rol", ["id" => $data->id])}}" class="btn-accion-tabla tooltipsC" title="Editar este rol">
