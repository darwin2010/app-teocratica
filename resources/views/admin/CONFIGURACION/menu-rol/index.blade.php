...
<div class="row">
    <div class="col-lg-12">
        ...
        <h3 class="card-title"><b>Administracion - APP</B> \ Menu Rol</h3>
            </div>
                        ...
                        @endif
                            ...
                            @foreach($menu["submenu"] as $key => $hijo)
                                ...
                                @foreach ($hijo2["submenu"] as $key => $hijo3)
                                        ...
                                        <tr>
                                            <td class="pl-40"><i class="fa fa-arrow-right"></i> {{$hijo4["nombre"]}}</td>
                                            @foreach($rols as $id => $nombre)
                                            <td class="text-center">
                                                <input
                                                type="checkbox"
                                                ...
                                                value="{{$id}}" {{in_array($id, array_column($menusRols[$hijo4["id"]], "id"))? "checked" : ""}}>
                                            </td>
                                            @endforeach
                                        </tr>
                                        @endforeach
