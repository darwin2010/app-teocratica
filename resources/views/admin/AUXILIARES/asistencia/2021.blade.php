    ...
    <div class="col-lg-12">
        ...
        <div class="card card-navy">
            <div class="card-header">
                <h3 class="card-title"><b>GESTION DE AUXILIARES </b> \ Asistencia A Las Reuniones</h3><h5 align="right">2021</h5>
            </div>
        </div>
                        ...
                        @foreach ($datas as $data) 
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="{{route('editar_2021', ['id' => $data->id])}}" class="btn-accion-tabla tooltipsC" title="Editar este registro">
