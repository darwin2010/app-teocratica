    ...
    <div class="col-lg-12">
        ...
        <div class="card card-navy">
            <div class="card-header">
                <h3 class="card-title"><b>GESTION DE AUXILIARES </b> \ Informes</h3><h5 align="right">2020</h5>
            </div>
        </div>
        <div class="card card-primary card-outline">
            <div class="card-header">
                <h4 class="text-center"><b>Informe De Servicio - Grupo 2 - Mes De Septiembre</b></h4>
            </div>
            <div class="card-body"> 
