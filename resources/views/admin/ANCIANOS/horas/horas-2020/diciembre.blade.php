...
<div class="row">
    <div class="col-lg-12">
        ...
        <div class="card card-primary card-outline">
            <div class="card-header">
                <h4 class="text-center"><b>PRUBLICADORES - DICIEMBRE</b></h4>
            </div>
            <div class="card-body"> 
        ...
        <div class="card card-primary card-outline">
            <div class="card-header">
                <h4 class="text-center"><b>PRECURSORES AUXILIARES - DICIEMBRE</b></h4>
            </div>
            <div class="card-body"> 
              <div class="table table-sm table-responsive p-2">
                <table class="table table-striped table-bordered" id="tabla-data">
    ...
    <div class="card card-primary card-outline">
        <div class="card-header">
            <h4 class="text-center"><b>PRECURSORES REGULARES - DICIEMBRE</b></h4>
        </div>
            <div class="card-body">            
    ...
    <div class="card card-primary card-outline">
        <div class="card-header">
            <h4 class="text-center"><b>INFORME TOTAL DE DICIEMBRE</b></h4>
        </div>
            <div class="card-body">            
              <div class="table table-sm table-responsive">
                <table class="table table-striped table-bordered" id="tabla-data">
