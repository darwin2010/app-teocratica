...
<div class="row">
    <div class="col-lg-12">
        ...
        <div class="card card-navy">
            <div class="card-header">
                <h3 class="card-title"><b>GESTION DE ANCIANOS </b> \ Resumen De Horas Mensual</h3><h5 align="right">2020</h5>
            </div>
        </div>
        <div class="card card-primary card-outline">
            <div class="card-header">
                <h4 class="text-center"><b>PRUBLICADORES - SEPTIEMBRE</b></h4>
            </div>
            <div class="card-body"> 
        ...
        <div class="card card-primary card-outline">
            <div class="card-header">
                <h4 class="text-center"><b>PRECURSORES AUXILIARES - SEPTIEMBRE</b></h4>
            </div>
            <div class="card-body"> 
              <div class="table table-sm table-responsive p-2">
                <table class="table table-striped table-bordered" id="tabla-data">
    ...
    <div class="card card-primary card-outline">
        <div class="card-header">
            <h4 class="text-center"><b>PRECURSORES REGULARES - SEPTIEMBRE</b></h4>
        </div>
            <div class="card-body">            
    ...
    <div class="card card-primary card-outline">
        <div class="card-header">
            <h4 class="text-center"><b>INFORME TOTAL DE SEPTIEMBRE</b></h4>
        </div>
            <div class="card-body">            
              <div class="table table-sm table-responsive">
                <table class="table table-striped table-bordered" id="tabla-data">
